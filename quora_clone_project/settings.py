"""
Django settings for quora_clone_project project.
...
TEMPLATE_DIR = os.path.join(BASE_DIR,'templates') # as we have a templates folder in the project directry not in app.
...
SECRET_KEY = '83fdab97b54306bb654c3dd5ddc24137'
...
ROOT_URLCONF = 'quora_clone_project.urls'
...
WSGI_APPLICATION = 'quora_clone_project.wsgi.application'
